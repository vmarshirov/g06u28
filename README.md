...
https://telemost.yandex.ru/j/10182333286060
<!--
<pre>
Возможно, что сегодня 2023-12-06 я буду недоступен в неопределенное время и поэтому предлагаю: 
Отправить мне сообщение с темой "Контролные работы" по адресу vmarshirov@hse.ru

В письме указать работающие ссылки на созданные сайты и ссылки на соответствующие репозитории
или
Прикрепить сжатые архивы созданных сайтов

Я все проверю, выставлю в ведомость предварительные оценки. Ведомость загружу в https://disk.yandex.ru/d/YgdAyfTxy5Cq2w
Если оценка не будет соответствовать ожидаемой - обсудим это на очередном семинаре
