...
async function fetchHTML(content_url) {
   console.log("content_url: ", content_url)
    ...
    let component = await (document.getElementById("component"))
    component.innerHTML = content
}

async function component_html(content_url, content_file_key) {
     await activeNavigTitle(content_file_key)
     await fetchHTML(content_url)
...
async function fetchJson() {
    ...
    let response = await fetch("../public_html/pages/component_json.json")
    let content = await response.text()
    console.log("content: ", content)
...
component_result =  component_html(content_url, search_obj.content_file_key)
console.log("component_result: ", component_result)
form_abc(component_result);
}
else{
component_result = component_json(content_url, search_obj.content_file_key)
console.log("component_result: ", component_result)
}

/*async function form_abc(){
    console.log("form_abc.js")
    const res = await fetch("../js/form_abc.js")
    console.log("form_abc.js")
}*/
...
function verify_send() {
 ...
 async function form_abc(component_result){
    await console.log("form_abc.js", component_result)
    let  messageText = document.getElementById("result").innerText
    console.log("form_abc, component_result: ", messageText, component_result)
    let result;
    let check = false;
...
//import {form_abc} from "./form_abc.js";
